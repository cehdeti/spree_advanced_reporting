Spree::Admin::ReportsController.class_eval do
  ...
  before_action :basic_report_setup, only: [:daily_details, :profit, :revenue, :units, :top_products, :top_customers, :geo_revenue, :geo_units, :count]
  ...
  ADVANCED_REPORTS = [
    ...
    [x, { name: I18n.t("adv_report.#{x}"), description: I18n.t("adv_report.#{x}") }]
  end.to_h.freeze
